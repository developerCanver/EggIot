...
<div class="form-group">
    ...
    <input type="file" class="form-control" wire:model="profile_photo_path" id="exampleFormControlInput2">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select wire:model="distribuidora_id" class="form-control">
                                            <option value="" selected>Seleccione Distribuidora...</option>
                                            @foreach ($distribuidoras as $distribuidora)
                                            <option value="{{$distribuidora->id_distributor }}">
                                                {{$distribuidora->nameDistributor}}</option>
                                            @endforeach
                                        </select>
                                        @error('distribuidora_id') <span
                                            class="text-danger">{{ $message }}</span>@enderror
                                    </div>
                                </div>
