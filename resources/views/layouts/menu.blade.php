<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Reporte Huevos<span class="fa arrow"></span></a>
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Tipo JUMBO<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Tipo AAA<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Tipo AA<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Tipo A<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Tipo B<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li>
                <a href="inbox.html" class="waves-effect"><i  class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Tipo C<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            <li><a href="{{ url('iot')}}" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="&#xe000;"></i> <span class="hide-menu">Sensores</span></a></li>
            <li><a href="{{ url('clasificacion')}}" class="waves-effect"><i data-icon=")" style="padding: 0 4px;
                font-size: 18px;" class=" fa fa-spin fa-cog"></i> <span class="hide-menu">INF tabla clasificación</span></a></li>
